...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Official List</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="student_table" class="display nowrap" width="100%">
                ...
                if (json.data) {
                    for (let i = 0; i < json.data.length; i++) {
                        if (json.data[i].is_enrolled === "FALSE") {
                            ...
                            var status_ok =
                                "<button type='button' class='btn btn-success btn-sm approve btn-block' data-id='" +
                                json.data[i].id +
                        ...
                        return_data.push({
                            ...
                            status: json.data[i].date_enrolled
                        });
                    }
